...
import Navbar from "../landing-page-componets/Navbar";
// import "../theams/theam.css";
import { themes } from "../theams/theam";
...
<section className="container py-5">
  ...
  <div className="text-center mt-4">
    <button
      ...
      style={{ borderRadius: "8px", fontWeight: "bold", ...ubuntuFont,border: "2px solid var(--primary)",
    color: "var(--primary)",
...
<div className="container py-4">
  <h2 className="fw-bold mb-4" style={{ color: "var(--primary)", ...ubuntuFont }}>
    Choose Theme
  </h2>
        <div className="row g-3">
          {themeList.map((t) => {
