...
// // //         : initials(email)
// // //       }
// // //       {/* ✅ FIX: online badge always visible regardless of photo */}
...
// // // .admc-incoming-call{background:#14141c;border:1px solid #2a2a38;border-radius:20px;padding:32px 24px;width:100%;max-width:340px;display:flex;flex-direction:column;align-items:center;animation:admc-modal-in .2s cubic-bezier(.34,1.56,.64,1);box-shadow:0 24px 64px rgba(0,0,0,.5)}
// // // .admc-ic-ring{width:80px;height:80px;border-radius:50%;position:relative;display:flex;align-items:center;justify-content:center;margin-bottom:20px}
// // // .admc-ic-ring::before,.admc-ic-ring::after{content:'';position:absolute;inset:0;border-radius:50%;border:2px solid rgba(22,163,74,.5);animation:admc-ring-pulse 2s ease-out infinite}
// // // .admc-ic-ring::after{animation-delay:.7s}
// // // @keyframes admc-ring-pulse{0%{transform:scale(1);opacity:.8}100%{transform:scale(1.7);opacity:0}}
// // // .admc-ic-btns{display:flex;gap:32px;margin-top:28px}
// // // .admc-ic-btn{width:60px;height:60px;border-radius:50%;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:transform .15s,opacity .15s}
// // // .admc-ic-btn:hover{opacity:.85}
// // // .admc-ic-btn:active{transform:scale(.92)}
// // // .admc-ic-btn.accept{background:#16a34a;box-shadow:0 4px 16px rgba(22,163,74,.4)}
// // // .admc-ic-btn.decline{background:#ef4444;box-shadow:0 4px 16px rgba(239,68,68,.4)}
// // // .admc-ic-btn svg{width:24px;height:24px;fill:none;stroke:#fff;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}
// // // .admc-call-modal{background:#14141c;border:1px solid #2a2a38;border-radius:20px;padding:36px 28px;width:100%;max-width:340px;display:flex;flex-direction:column;align-items:center;animation:admc-modal-in .2s cubic-bezier(.34,1.56,.64,1);box-shadow:0 24px 64px rgba(0,0,0,.5)}
// // // .admc-call-avatar{width:80px;height:80px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:28px;font-family:'JetBrains Mono',monospace;border:2px solid;margin-bottom:16px;overflow:hidden}
// // // .admc-call-name{font-size:18px;font-weight:700;color:#f0f0f8;margin-bottom:6px;text-align:center;max-width:260px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
// // // .admc-call-status{font-size:12px;color:#8888a8;margin-bottom:32px;font-family:'JetBrains Mono',monospace;letter-spacing:.5px;text-align:center}
// // // .admc-call-actions{display:flex;gap:20px;align-items:center}
// // // .admc-call-btn{width:56px;height:56px;border-radius:50%;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:opacity .15s,transform .1s;flex-shrink:0}
// // // .admc-call-btn:hover{opacity:.85}
// // // .admc-call-btn:active{transform:scale(.92)}
// // // .admc-call-btn.end{background:#ef4444;box-shadow:0 4px 16px rgba(239,68,68,.4)}
// // // .admc-call-btn.mute{background:#1e1e28;border:1px solid #2a2a38}
// // // .admc-call-btn.cam{background:#1e1e28;border:1px solid #2a2a38}
// // // .admc-call-btn svg{width:22px;height:22px;fill:none;stroke:#fff;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}
// // // .admc-call-timer{font-size:11px;color:#55556a;font-family:'JetBrains Mono',monospace;margin-top:20px}
...
// // // /* ─── INCOMING CALL MODAL ─── */
// // // const IncomingCallModal = ({ callInfo, onAccept, onDecline }) => {
// // //   const pal = hashColor(callInfo.email);
// // //   return (
// // //     <div className="admc-overlay">
// // //       <div className="admc-incoming-call">
// // //         <div className="admc-ic-ring">
// // //           <div className="admc-avatar" style={{ width: 80, height: 80, fontSize: 26, background: pal.bg, color: pal.color, borderColor: pal.border, overflow: 'hidden' }}>
// // //             {callInfo.photoUrl
// // //               ? <img src={`http://localhost:5000${callInfo.photoUrl}`} alt="" style={{ width:'100%',height:'100%',objectFit:'cover',borderRadius:'50%' }} />
// // //               : initials(callInfo.email)
// // //             }
// // //           </div>
// // //         </div>
// // //         <div style={{ fontSize: 18, fontWeight: 700, color: '#f0f0f8', marginBottom: 4 }}>{callInfo.email}</div>
// // //         <div style={{ fontSize: 12, color: '#8888a8', fontFamily: 'JetBrains Mono,monospace', marginBottom: 8 }}>
// // //           Incoming {callInfo.type === 'voice' ? '📞 Voice' : '📹 Video'} Call…
// // //         </div>
// // //         <div className="admc-ic-btns">
// // //           <div style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:6 }}>
// // //             <button className="admc-ic-btn decline" onClick={onDecline}>
// // //               <svg viewBox="0 0 24 24" style={{ transform:'rotate(135deg)' }}><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81 19.79 19.79 0 011 1.24 2 2 0 013 .06h3a2 2 0 012 1.72c.13.96.36 1.9.7 2.81a2 2 0 01-.45 2.11L7.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0122 14.92z"/></svg>
// // //             </button>
// // //             <span style={{ fontSize:11, color:'#55556a', fontFamily:'monospace' }}>Decline</span>
// // //           </div>
// // //           <div style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:6 }}>
// // //             <button className="admc-ic-btn accept" onClick={onAccept}>
// // //               {callInfo.type === 'voice'
// // //                 ? <svg viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81 19.79 19.79 0 011 1.24 2 2 0 013 .06h3a2 2 0 012 1.72c.13.96.36 1.9.7 2.81a2 2 0 01-.45 2.11L7.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0122 14.92z"/></svg>
...
// // // /* ─── ACTIVE CALL MODAL ─── */
// // // const ActiveCallModal = ({ type, email, photoUrl, onEnd }) => {
...
// // //   return (
// // //     <div className="admc-overlay">
// // //       <div className="admc-call-modal">
// // //         <div className="admc-call-avatar" style={{ background: pal.bg, color: pal.color, borderColor: pal.border }}>
// // //           {photoUrl
// // //             ? <img src={`http://localhost:5000${photoUrl}`} alt="" style={{ width:'100%',height:'100%',objectFit:'cover' }} />
// // //             : initials(email)
// // //           }
// // //         </div>
// // //         <div className="admc-call-name">{email}</div>
// // //         <div className="admc-call-status">{type === 'voice' ? '📞 Voice call' : '📹 Video call'} · {fmt(seconds)}</div>
// // //         <div className="admc-call-actions">
// // //           <button className="admc-call-btn mute" onClick={() => setMuted(p => !p)} style={{ opacity: muted ? 0.5 : 1 }}>
// // //             {muted
...
// // //             }
// // //           </button>
// // //           <button className="admc-call-btn end" onClick={onEnd}>
// // //             <svg viewBox="0 0 24 24" style={{ transform:'rotate(135deg)' }}><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81 19.79 19.79 0 011 1.24 2 2 0 013 .06h3a2 2 0 012 1.72c.13.96.36 1.9.7 2.81a2 2 0 01-.45 2.11L7.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0122 14.92z"/></svg>
// // //           </button>
// // //           {type === 'video' && (
// // //             <button className="admc-call-btn cam" onClick={() => setCamOff(p => !p)} style={{ opacity: camOff ? 0.5 : 1 }}>
// // //               {camOff
// // //                 ? <svg viewBox="0 0 24 24"><line x1="1" y1="1" x2="23" y2="23"/><path d="M21 21H3a2 2 0 01-2-2V8a2 2 0 012-2h3m3-3h6l2 3h4a2 2 0 012 2v9.34"/><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z"/></svg>
// // //                 : <svg viewBox="0 0 24 24"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>
// // //               }
// // //             </button>
// // //           )}
// // //         </div>
// // //         <div className="admc-call-timer">Connected · {fmt(seconds)}</div>
// // //       </div>
// // //     </div>
// // //   );
// // // };
...
// // //       if (!inEmojiPanel.current) { setHovered(false); setShowEmoji(false); }
// // //     }, 280);
// // //   };
...
// // //   const [incomingCall, setIncomingCall] = useState(null); // { callId, type, email, userId, photoUrl }
// // //   const [activeCall,   setActiveCall]   = useState(null); // { type, email, photoUrl }
...
// // //   /* ── FETCH USERS — also updates online status ── */
...
// // //   // ✅ FIX: correct URL /api/chat/admin/calls/pending (not /api/chat/calls/pending)
// // //   useEffect(() => {
...
// // //         const data = await res.json();
// // //         if (data.success && data.call && !incomingCall) {
...
// // //   // ✅ FIX: correct URL /api/chat/admin/calls/:id/accept
// // //   const acceptCall = async () => {
// // //     try {
// // //       await fetch(`${API_BASE}/chat/admin/calls/${incomingCall.callId}/accept`, {
// // //         method: 'POST', headers: auth(),
// // //       });
// // //     } catch {}
// // //     setActiveCall({ type: incomingCall.type, email: incomingCall.email, photoUrl: incomingCall.photoUrl });
// // //     setIncomingCall(null);
// // //   };

// // //   // ✅ FIX: correct URL /api/chat/admin/calls/:id/decline
// // //   const declineCall = async () => {
// // //     try {
// // //       await fetch(`${API_BASE}/chat/admin/calls/${incomingCall.callId}/decline`, {
// // //         method: 'POST', headers: auth(),
// // //       });
// // //     } catch {}
// // //     setIncomingCall(null);
...
// // // // ─────────────────────────────────────────────────────────────────
// // // // In AdminChat.jsx, FIND the existing initiateCall function and
// // // // REPLACE the entire function with this one.
// // // // Do NOT add showAlert again — it already exists in the file.
// // // // ─────────────────────────────────────────────────────────────────
...
// // //       }
// // //     } catch {
// // //       showAlert('err', 'Network error. Could not initiate call.');
// // //     }
// // //   };
...
// // //       finally { mutatingRef.current = false; await fetchMessagesRaw(selectedUser); }
// // //       return;
// // //     }
...
// // //   const startEdit  = (msg) => { setEditingMsg({ id: msg.id }); setInput(msg.message || ''); setTimeout(() => textareaRef.current?.focus(), 50); };
// // //   const cancelEdit = () => { setEditingMsg(null); setInput(''); if (textareaRef.current) textareaRef.current.style.height = 'auto'; };

// // //   const selectUser = (userId) => {
// // //     setSelectedUser(userId); setMessages([]); setEditingMsg(null); setInput(''); setAttachments([]);
// // //     setLoading(true);
...
// // //   useEffect(() => {
// // //     fetchUsers();
// // //     // ✅ Poll users every 8s to keep online status fresh
...
// // //       if (day !== lastDay) { out.push({ type:'day', label:day, key:`d-${day}` }); lastDay = day; }
...
// // //       {incomingCall && (
// // //         <IncomingCallModal callInfo={incomingCall} onAccept={acceptCall} onDecline={declineCall} />
// // //       )}

// // //       {activeCall && (
// // //         <ActiveCallModal type={activeCall.type} email={activeCall.email} photoUrl={activeCall.photoUrl} onEnd={() => setActiveCall(null)} />
// // //       )}
...
// // //               {/* ✅ FIX: online prop comes from u.online — make sure backend returns this */}
...
// // //                 {/* ✅ FIX: online status shown correctly */}
...
// // //                 </div>
// // //               </div>
// // //               {/* ✅ FIX: call buttons call initiateCall with correct URL */}
...
// //   // 2. REPLACED incomingCall + activeCall with single activeRTCCall state
// //   // shape: { callId, type, mode: 'caller'|'callee', peerEmail }
...
// //   // 3. REPLACED old call polling useEffect with WebRTC-aware version
// //   useEffect(() => {
// //     const pollCalls = async () => {
// //       if (activeRTCCall) return; // don't poll during active call
// //       try {
// //         const res  = await fetch(`${API_BASE}/chat/admin/calls/pending`, { headers: auth() });
// //         const data = await res.json();
...
// //   // 4. REPLACED initiateCall with WebRTC-aware version
// //   const initiateCall = async (type) => {
// //     if (!selectedUser) {
// //       showAlert('err', 'Please select an employee first.');
// //       return;
...
// //       {/* 5. REPLACED IncomingCallModal + ActiveCallModal with single WebRTCCall component */}
// //       {activeRTCCall && (
// //         <WebRTCCall
...
// //           callerRole={activeRTCCall.mode === 'caller' ? 'admin' : 'employee'}
...
//   // Single state for any active/incoming RTC call
//   const [activeRTCCall, setActiveRTCCall] = useState(null);
...
//   const selectedUserRef = useRef(null);
//   const themeRef        = useRef(null);
//   // KEY FIX: track call IDs we've already shown to prevent re-triggering
...
//   // Poll for incoming calls — with seenCallIds guard
//   useEffect(() => {
//     const pollCalls = async () => {
...
//           // KEY FIX: only show if we haven't seen this call ID before
...
//   // Initiate outgoing call (admin → employee)
//   const initiateCall = async (type) => {
//     if (!selectedUser) {
//       showAlert('err', 'Please select an employee first.');
//       return;
...
//         // Also mark this callId as seen so we don't re-trigger it as incoming
...
//       {/* WebRTC call — myRole is always 'admin' here */}
//       {activeRTCCall && (
//         <WebRTCCall
//           mode={activeRTCCall.mode}
//           callId={activeRTCCall.callId}
