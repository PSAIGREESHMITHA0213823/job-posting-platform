...
//   // Call this after saving profile to instantly sync sidebar
//   const refreshProfile = () => fetchProfile();

//   // Or directly set logo without refetching (faster)
//   const updateLogo = (url) => {
//     setLogoUrl(url.startsWith('http') ? url : `http://localhost:5000${url}`);
//   };

//   return (
//     <CompanyContext.Provider value={{ companyName, logoUrl, loading, refreshProfile, updateLogo }}>
//       {children}
