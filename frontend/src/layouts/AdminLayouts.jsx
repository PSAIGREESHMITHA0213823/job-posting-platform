...
import {
  ...
  MessageSquare ,MessageCircle // 🔥 added
} from 'lucide-react';
...
export default function AdminLayout() {
  ...
  // Poll for waiting chat sessions every 30s
  useEffect(() => {
      ...
      <aside style={{
        ...
        <nav style={{ flex: 1, padding: '6px 8px', overflowY: 'auto', overflowX: 'hidden' }}>
          <div style={{
            ...
            fontFamily: 'var(--mono)', padding: '8px 10px 4px',
          }}>
      ...
      <div style={{
        ...
        <header style={{
          ...
          {waitingCount > 0 && (
            ...
            >
              <MessageSquare size={13} color="var(--amber)" />
