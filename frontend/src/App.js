...
// // // import { AuthProvider } from './contexts/AuthContext';  // ✅ NO useAuth here
// // // import { PrivateRoute, PublicRoute } from './components/RouteGuards'; // ✅ moved out

// // // import SuperAdminProfile from './pages/SuperAdminProfile';

// // // // ---------- Helper ----------
// // // function getComponent(module, fallbackName = 'Component') {
// // //   if (typeof module === 'function' || (typeof module === 'object' && module?.$$typeof)) return module;
// // //   if (module && typeof module === 'object' && module.default) return module.default;
// // //   const keys = Object.keys(module);
// // //   if (keys.length === 1 && typeof module[keys[0]] === 'function') return module[keys[0]];
// // //   console.error(`❌ Could not resolve component "${fallbackName}"`, module);
// // //   return () => null;
// // // }
...
// import Revenue from './pages/Revenue';
// import Settings from './pages/Settings';
// import SuperAdminProfile from './pages/SuperAdminProfile'; // ✅ added
...
// import EmployeeChatDashboard from './components/EmployeeChatbot';
// // ---------- Helpers ----------
// const Spinner = () => (
//   <div className="d-flex align-items-center justify-content-center vh-100">
//     <LoadingSpinner />
...
//             <Route path="subscriptions" element={<SubscriptionPlans />} />
//             <Route path="revenue" element={<Revenue />} />
//             <Route path="profile" element={<SuperAdminProfile />} /> {/* ✅ added */}
//             <Route path="settings" element={<Settings />} />
//           </Route>
      ...
      <BrowserRouter>
        <Routes>
          ...
          >
            ...
            <Route path="profile" element={<SuperAdminProfile />} />
            <Route path="settings" element={<Settings />} />
            {/* ✅ Admin chat route — added here as a nested page */}
        ...
        {/* ✅ Floating chatbot — only shows for employees, outside Routes */}
