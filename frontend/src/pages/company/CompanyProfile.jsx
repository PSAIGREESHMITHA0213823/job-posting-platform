...
// // ─────────────────────────────────────────────────────────────────────────────
// // HOW TO FIX "Network Error"  — pick ONE option:
// //
// //  OPTION A — proxy (recommended, zero CORS hassle):
// //    In your React project's package.json add:
// //      "proxy": "http://localhost:5000"
// //    Then leave API as '/api' below and restart the dev server.
// //
// //  OPTION B — .env file in your React project root:
// //    REACT_APP_API_URL=http://localhost:5000/api
// //    AND on your Express backend:
// //      app.use(require('cors')({ origin: 'http://localhost:3000', credentials: true }))
// //
// //  OPTION C — quick hardcode for local testing:
// //    Change the fallback below to 'http://localhost:5000/api'
// // ─────────────────────────────────────────────────────────────────────────────
...
// const SectionTitle = ({ children }) => (
//   <h4 style={{ fontSize: 14, fontWeight: 700, color: '#1a1f36', marginBottom: 16,
...
// const inputStyle = {
//   width: '100%', padding: '9px 12px', border: '1px solid #e5e7eb', borderRadius: 8,
//   fontSize: 14, color: '#1a1f36', boxSizing: 'border-box', outline: 'none',
...
//               ? d.logo_url
//               : `${window.location.protocol}//${window.location.hostname}:5000${d.logo_url}`
//           );
//         }
//         setError('');
//       })
//       .catch(err => {
//         if (!err.response) {
//           // Browser got no response — CORS preflight blocked or server not running
//           setError(
//             'Network Error: the browser could not reach the server. ' +
//             'Fix: add "proxy": "http://localhost:5000" to package.json ' +
//             '(or set REACT_APP_API_URL + enable CORS on the backend). ' +
...
//         }
//         console.error('[CompanyProfile] load failed', {
...
//     } catch (e) {
//       if (!e.response) {
//         setError('Network Error: could not reach the server while saving.');
//       } else {
//         setError(e.response?.data?.message || 'Update failed. Please try again.');
//       }
//       console.error('[CompanyProfile] save failed', e.response || e);
//     } finally {
//       setSaving(false);
//     }
//   };
...
//   // ── render ────────────────────────────────────────────────────────────────
//   return (
//     <div style={{ maxWidth: 780, padding: '0 4px' }}>

//       {/* Page header */}
//       <div style={{ marginBottom: 24 }}>
//         <h2 style={{ fontSize: 22, fontWeight: 800, color: '#1a1f36',
...
//           color: '#991b1b', borderRadius: 8, fontSize: 13, lineHeight: 1.6 }}>
//           ⚠️ {error}
//         </div>
//       )}
