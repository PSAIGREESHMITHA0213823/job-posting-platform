...
const CompanyApplications = () => {
  ...
  const [notes, setNotes]             = useState({});   // local notes per applicant
  const [activeTab, setActiveTab]     = useState('profile'); // profile | notes
  ...
  // save note locally (extend to API if needed)
